...
Puedes probar el ejemplo directamente aquí:

<iframe
  src="https://stackblitz.com/edit/stackblitz-starters-oq3pb52l?embed=1&file=src%2Fglobal_styles.css"
  title="Ejemplo interactivo de Angular Signals"
  width="100%"
  height="500"
  loading="lazy"
